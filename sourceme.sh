...
# show all options -> # EXCLUDE="clean.sh ai_deck.sh common.sh gap8.sh gap8_v2.sh gap8_v3.sh gap9.sh jlink.sh openocd.sh gapoc_a.sh gapoc_a_v2.sh gapoc_a_spi_v2.sh gapoc_b.sh gapuino.sh gapuino_v2.sh gapuino_v2_spi.sh"
EXCLUDE_FILES=
for i in $EXCLUDE
do
